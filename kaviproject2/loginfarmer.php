...
<br><br>
		...
		<div class="box">
			<form method="post"  class="form-horizontal" action="loginfarmer.php">
...
<br>
				...
				<center><input class="btn btn-success" type="submit" value="login" name="login_farmer">
				</center>
				
				<div><br>
				<a href="signupfarmer.php">don't have an account? register</a>
				</div>	
